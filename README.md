...
Below here is old
sudo apt-get -y install build-essential cmake  cmake-curses-gui pkg-config libpng12-0 libpng12-dev libpng++-dev libpng3 libpnglite-dev zliblg-dbg zliblg zliblg-dev pngtools libtiff4-dev libtiff4 libtiffxx0c2 libtiff-tools libeigen3-dev
